...
public class ManagaProviderSchedulePageTestcaseForHealthcare extends baseHealthcare {

	@Test 
	public void toVerifyThatAppoinmentIsBookOrNot() {
		...
		home5.ManageProviderSchedule(driver);
